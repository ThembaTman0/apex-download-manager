...
export function TopBar() {
  return (
    <header
      ...
      className="flex items-center h-9 bg-surface border-b border-white/[0.06] shrink-0"
    >
...
function WinButton({
  ...
  return (
    <button
      ...
      aria-label={label}
      className={cn(
        "w-11 flex items-center justify-center text-ink-muted transition-colors",
        danger
          ? "hover:bg-error-hover hover:text-ink"
