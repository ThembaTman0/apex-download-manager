...
const FEATURES: Array<{ icon: ReactNode; title: string; body: string }> = [
  ...
  },
  {
    ...
    body: "Progress is saved per segment as it arrives. Pause, reboot, or lose your connection, then continue from the same byte.",
  },
  {
    icon: <CaptureIcon />,
  ...
  },
  {
    ...
    body: "Start downloads at a set time, limit how many run at once, and have the PC sleep or shut down when the queue empties.",
  },
  {
    icon: <ShieldCheckIcon />,
    title: "Checksum verification",
    body: "Paste the SHA-256 from the publisher's site and Apex compares it against the finished file.",
  },
  {
    icon: <CommandIcon />,
    title: "Keyboard shortcuts",
    body: "Add, search, pause, resume and delete without the mouse. A clipboard watcher offers to queue links you copy.",
  },
];
